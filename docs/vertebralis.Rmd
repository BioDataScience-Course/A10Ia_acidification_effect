...
-   Chaque groupe comprend dix individus. On observe deux moyennes proches de 0% et deux moyennes très légèrement plus faibles.
...
<!--% Réalisez le test de comparaison multiple, si cela est justifié. Pour ce faire, retirez un dièse à chaque ligne du chunk ci-dessous devant le code et complétez les zones manquantes. -->
...
-   La distribution des résidus suit une distribution presque normale.

-   La distribution des résidus ne suit pas une distribution normale. Il est préférable de transformer les données.
